...
class FinancialTrackingList extends StatefulWidget {
  const FinancialTrackingList({super.key});
...
class _FinancialTrackingListState extends State<FinancialTrackingList> {
  ...
  getontheload() async {
    financialStream = await DatabaseMethods().getFinancialDetails();
    setState(() {});
  }
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            Color amountColor =
                ds['type'] == 'Income' ? Colors.green : Colors.red;
